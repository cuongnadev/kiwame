...
export const getUserMenuItems = (channel?: string | null): MenuItem[] => [
...
export const getCreateMenuItems = (channel?: string | null): MenuItem[] => [
...
export const getUserDropdownMenu = (channel?: string | null): MenuItem[] => [
