export { default as ComponentsVideoUpload } from "./upload/ComponentVideoUpload";
export { default as DetailVideoUpload } from "./upload/DetailVideoUpload";
export { default as UploadEditDetails } from "./upload/UploadEditDetail";
export { default as UploadSelectedFile } from "./upload/UploadSelectedFile";
