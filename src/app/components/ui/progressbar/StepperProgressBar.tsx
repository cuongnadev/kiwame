...
export default function StepperProgressBar({ currentStep, handleStepClick}: StepperProgressBarProps) {
    const steps = [
        { id: 1, label: 'Chi tiết', status: 'editing' },
        { id: 2, label: 'Các thành phần của video', status: 'editing' },
        { id: 3, label: 'Chế độ hiển thị', status: 'editing' },
    ]
                                ...
                                >
                                    ...
                                    <div className=" text-center">
                                        <div
                                            className={`
                                              ...
                                              ${isCurrent || isCompleted ? 'text-white' : 'text-neutral-500'}
                                            `}
                                        >
                                            {step.label}
                                        </div>
                                    ...
                                    <div
                                        className={`
                                          ...
                                          ${isCurrent ? 'bg-white ring-4 ring-white ring-opacity-30' : ''}
